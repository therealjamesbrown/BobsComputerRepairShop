...
function CreateorderComponent_div_9_Template(rf, ctx) { if (rf & 1) {
...
CreateorderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CreateorderComponent, selectors: [["app-createorder"]], decls: 32, vars: 1, consts: [[3, "ngSubmit"], ["serviceRepairForm", "ngForm"], ["fxLayout", "column"], ["fxFlex", ""], ["ngModelGroup", "checkGroup", 4, "ngFor", "ngForOf"], ["fxFlex", "", 2, "width", "300px !important"], ["matInput", "", "name", "parts", "ngModel", "0", "placeholder", "Parts"], ["matInput", "", "name", "labor", "ngModel", "0", "placeholder", "Labor @ 50.00/hr"], ["align", "end"], ["mat-raised-button", "", "type", "reset", "color", "warn"], ["mat-raised-button", "", "color", "primary"], ["ngModelGroup", "checkGroup"], ["ngModel", "", 3, "name"]], template: function CreateorderComponent_Template(rf, ctx) { if (rf & 1) {
