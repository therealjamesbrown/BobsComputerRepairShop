        ...
        _createClass(SigninComponent, [{
          ...
          value: function signin() {
            ...
            this.http.post('/api/session/signin', {
              ...
              _this2.errorMessage = 'Invalid username or password. Try again.';

              _this2.openSnackBar(_this2.errorMessage);
            });
          }
        }, {
          key: "openSnackBar",
