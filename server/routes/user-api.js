...
//let cors = require('cors') - 10/25 JB commenting out so Sarah and I can continue to work
...
//router.use(cors()) - //let cors = require('cors') - 10/25 JB commenting out so Sarah and I can continue to work
